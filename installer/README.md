...
./installer/build_linux_app.sh 4.0.0
```
...
```bash
bash installer/build_linux_app.sh 4.0.0
tar -xzf dist/Row-Bot-4.0.0-Linux-*.tar.gz
cd Row-Bot-4.0.0-Linux-*
./install.sh
~/.local/bin/row-bot
```
