...
./installer/build_linux_app.sh 3.23.1
```
...
```bash
bash build_linux_app.sh 3.23.1
```
...
```bash
bash installer/build_linux_app.sh 3.23.1
tar -xzf dist/Thoth-3.23.1-Linux-*.tar.gz
cd Thoth-3.23.1-Linux-*
./install.sh
~/.local/bin/thoth
```
...
3. Compile everything into `dist\ThothSetup_3.23.1.exe`
