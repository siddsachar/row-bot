...
SOURCE_TEST_RULES: tuple[SourceTestRule, ...] = (
    ...
    SourceTestRule(
        ...
        ("src/row_bot/application/workspace_undo_commands.py", "src/row_bot/developer/client_undo.py",
         ...
         "src/row_bot/developer/edits.py", "src/row_bot/developer/inspector_snapshot.py"),
    ...
    SourceTestRule(
        ...
        ("src/row_bot/application/document_*.py", "src/row_bot/document_jobs.py",
         "src/row_bot/document_extraction.py", "src/row_bot/document_index.py", "src/row_bot/documents.py",
         "src/row_bot/embedding_providers.py", "src/row_bot/models.py", "src/row_bot/memory*.py",
         "src/row_bot/knowledge_graph.py", "src/row_bot/wiki_vault.py", "src/row_bot/tools/memory_tool.py",
         "src/row_bot/providers/runtime.py", "src/row_bot/providers/*responses.py",
         "src/row_bot/providers/claude_subscription_messages.py", "src/row_bot/providers/openai_compatible.py"),
    ...
    SourceTestRule(
        ...
        ("src/row_bot/application/mcp_runtime_installation.py", "src/row_bot/mcp_client/requirements.py",
         "src/row_bot/runtime/admissions.py", "src/row_bot/api/v1/security.py", "src/row_bot/tools/registry.py"),
    ...
    SourceTestRule(
        ...
        (
            "frontend/**", "contracts/client-platform/**", "tests/browser/client_workspace/**",
            "docs/client-platform/**", "scripts/generate_client_platform_contracts.py",
            "src/row_bot/application/**", "src/row_bot/api/**", "src/row_bot/runtime/**",
            ...
            "src/row_bot/designer/client_editing.py", "src/row_bot/designer/client_exports.py",
            "src/row_bot/designer/client_sharing.py", "src/row_bot/designer/client_design_controls.py",
            ...
            "src/row_bot/developer/client_processes.py", "src/row_bot/developer/process_worker.py",
            ...
            "src/row_bot/voice/client_transport.py", "src/row_bot/voice/browser_local.py",
            "src/row_bot/ui/voice_lifecycle.py",
            "src/row_bot/voice/realtime_client.py",
            "src/row_bot/providers/reasoning.py", "src/row_bot/agent.py",
        ),
        (
            "tests/contracts/client_platform", "tests/subsystem/client_host",
            ...
            "tests/test_voice_actions.py", "tests/test_voice_coordinator.py",
    ...
    SourceTestRule(
        ...
        (
            ...
            "tests/test_browser_local_voice.py",
            "tests/subsystem/voice", "tests/subsystem/client_protocol/test_client_dictation.py",
    ...
    SourceTestRule(
        ...
        (
            ...
            "frontend/src/features/buddy/**", "frontend/src/features/shell/Buddy*.tsx",
            "src/row_bot/ui/buddy.py",
            "static/buddy/runtime/buddy.js",
        ),
        (
            "tests/test_buddy_core.py",
            "tests/subsystem/buddy", "tests/subsystem/client_protocol/test_buddy_api.py",
    ...
    SourceTestRule(
        "workflows",
        ("src/row_bot/tasks.py", "src/row_bot/task_views.py", "src/row_bot/application/task_*.py",
         "src/row_bot/workflows/**", "src/row_bot/agents/**"),
        (
            "tests/subsystem/workflows",
    ...
    SourceTestRule(
        ...
        ("src/row_bot/agent_tool_catalog.py", "src/row_bot/tools/registry.py",
         "src/row_bot/mcp_client/config.py", "src/row_bot/mcp_client/runtime.py",
         "src/row_bot/plugins/registry.py", "src/row_bot/plugins/state.py"),
    ...
    SourceTestRule(
        ...
        (
            ...
            "src/row_bot/application/knowledge_*.py", "src/row_bot/application/document_*.py",
            "src/row_bot/document_jobs.py", "src/row_bot/document_uploads.py",
            "src/row_bot/flat_vector_storage.py",
    ...
    SourceTestRule(
        "designer",
        ("src/row_bot/designer/**", "tests/fixtures/designer_runtime_bridge_security.cjs"),
        (
            "tests/subsystem/designer",
