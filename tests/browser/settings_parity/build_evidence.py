...
PAGES = (
    ...
    (4, "Wiki", "knowledge", "Knowledge tab — Wiki Vault subsection"),
    (5, "Buddy", "buddy", "src/row_bot/ui/buddy.py::build_buddy_settings_tab"),
    (6, "Goals", None, "React-only route; NiceGUI goal/profile owners"),
    (7, "Voice", "voice", "src/row_bot/ui/settings.py::_build_voice_tab"),
    (8, "System", "system", "src/row_bot/ui/settings.py::_build_system_access_tab"),
    (9, "Tracker", "tracker", "src/row_bot/ui/settings.py::_build_tracker_tab"),
    (10, "Documents", "documents", "src/row_bot/ui/settings.py::_build_documents_tab"),
    (11, "Tools", "tools", "src/row_bot/ui/settings.py::_build_tools_tab"),
    (12, "Skills", "skills", "src/row_bot/ui/settings.py::_build_skills_tab"),
    (13, "Accounts", "accounts", "src/row_bot/ui/settings.py::_build_accounts_tab"),
    (14, "Channels", "channels", "src/row_bot/ui/settings.py::_build_channels_tab"),
    (15, "Utilities", "utilities", "src/row_bot/ui/settings.py::_build_utilities_tab"),
    (16, "MCP", "mcp", "src/row_bot/ui/mcp_settings.py::build_mcp_settings_tab"),
    (17, "Plugins", "plugins", "src/row_bot/ui/settings.py::_build_plugins_tab"),
    (
        18,
        "Preferences",
        "preferences",
...
def _build_gallery(stage: str) -> tuple[str, str]:
    markdown: list[str] = [
        ...
        "",
        f"React stage: `{stage}`. Every available pair uses the same guarded host and unchanged mounted data state. Wiki maps to the NiceGUI Knowledge tab. Goals is explicitly React-only and therefore has no false NiceGUI peer.",
        "",
    ]
    cards: list[str] = []
