...
def test_runtime_brand_assets_are_file_backed_and_visible():
    ...
    buddy_src = _read("ui/buddy.py")
    launcher_src = _read("launcher.py")
    status_src = _read("ui/status_bar.py")
    helpers_src = _read("ui/helpers.py")
    head_src = _read("ui/head_html.py")
    command_src = _read("ui/command_center.py")
    task_dialog_src = _read("ui/task_dialog.py")
    designer_ui_src = _read("designer/ui_theme.py")
    template_gallery_src = _read("designer/template_gallery.py")
    page_navigator_src = _read("designer/page_navigator.py")
    interaction_src = _read("designer/interaction.py")
    telegram_src = _read("channels/telegram.py")
