...
from providers.capabilities import CHAT_TASKS, normalize_snapshot
from providers.catalog import model_info_from_metadata
from providers.models import TransportMode
from providers.resolution import ResolvedProviderConfig, resolve_provider_config
...
def evaluate_agent_readiness(
    ...
    *,
    ...
    if override_context:
        ...
        context_window = None
    try:
        from models import get_context_policy
    ...
    if resolved.provider_id.startswith("custom_openai_"):
        ...
        if probe_ollama_tools:
            try:
                from providers.ollama import probe_ollama_tool_round_trip
