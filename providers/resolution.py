...
from providers.catalog import get_provider_definition, infer_provider_id
from providers.models import TransportMode
from providers.selection import model_ref, parse_model_ref, provider_display_label, provider_icon_label
...
def _resolve_custom_openai(provider: str, model_id: str, source: str) -> ResolvedProviderConfig:
    from providers.custom import endpoint_id_from_provider_id, get_custom_endpoint
