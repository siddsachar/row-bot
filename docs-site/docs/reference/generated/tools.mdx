...
| computer_use | computer_use_guide | Provider-neutral, self-gating Computer Use tool. | Operation-dependent approval | `tool_guides/computer_use_guide/SKILL.md` | `src/row_bot/tools/computer_use_tool.py` |
