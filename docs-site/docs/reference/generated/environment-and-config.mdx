...
| ROW_BOT_ALLOWED_HOSTS | Allow exact HTTP Host authorities accepted by the access gate. | `src/row_bot/access/cli.py, src/row_bot/access/config.py, src/row_bot/access/diagnostics.py, src/row_bot/access/routes.py, src/row_bot/app.py, src/row_bot/application/settings_snapshot.py, src/row_bot/ui/remote_access_settings.py, src/row_bot/ui/settings.py` |
...
| ROW_BOT_XAI_OAUTH_CLIENT_ID | Override the xAI OAuth client identifier. | `src/row_bot/application/subscription_options.py, src/row_bot/providers/xai_oauth.py` |
