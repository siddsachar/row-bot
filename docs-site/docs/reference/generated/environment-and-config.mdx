...
| ROW_BOT_ALLOWED_HOSTS | Allow exact HTTP Host authorities accepted by the access gate. | `src/row_bot/access/cli.py, src/row_bot/access/config.py, src/row_bot/access/diagnostics.py, src/row_bot/app.py, src/row_bot/application/settings_snapshot.py, src/row_bot/ui/remote_access_settings.py, src/row_bot/ui/settings.py` |
