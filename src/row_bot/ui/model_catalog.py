...
from row_bot.providers.model_catalog import CatalogModelRow, group_rows_by_provider, rows_for_surface
    ...
    *,
    ...
    with catalog_expansion:
        ...
        async def _toggle_pin(row: CatalogModelRow, surface: str) -> None:
            from row_bot.providers.selection import add_quick_choice_for_model, remove_quick_choice_for_model
