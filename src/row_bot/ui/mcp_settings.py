...
from row_bot.mcp_client.conflicts import conflicts_for_entry, conflicts_for_server, requires_manual_tool_selection, unique_server_name
from row_bot.mcp_client.marketplace import MarketplaceEntry, MarketplaceSearchResult, entry_to_server_config, search_marketplace_with_status
from row_bot.mcp_client.requirements import RuntimeRequirement, check_server_requirements, install_managed_runtime, requirements_for_install
from row_bot.mcp_client.runtime import get_status_summary, probe_server, refresh_server, discover_enabled_servers
                ...
                with ui.row().classes("items-center gap-2"):
                    def _toggle_server(e, name=server_name):
                        ...
                        if e.value:
                            ...
                            from row_bot.mcp_client.runtime import stop_server
                            stop_server(name)
                        refresh()
